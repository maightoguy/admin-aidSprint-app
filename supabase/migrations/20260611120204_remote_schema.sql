...
alter table "public"."contractors" add column "restore_reason" text;

alter table "public"."contractors" add column "restored_at" timestamp with time zone;

alter table "public"."contractors" add column "restored_by" uuid;

alter table "public"."contractors" add column "suspended_at" timestamp with time zone;

alter table "public"."contractors" add column "suspended_by" uuid;

alter table "public"."contractors" add column "suspension_reason" text;
