...
drop policy "admin_action_log_select_admins" on "public"."admin_action_log";
...
drop policy "Admins can read contact feedback" on "public"."contact_feedback";
...
drop policy "dispute_evidence_insert_admins_only" on "public"."dispute_evidence";

drop policy "dispute_evidence_select_admins_only" on "public"."dispute_evidence";

drop policy "Admins can insert disputes" on "public"."disputes";

drop policy "Admins can update disputes" on "public"."disputes";

drop policy "Admins can update refund status on disputes" on "public"."disputes";
...
drop policy "Admins can insert finance audit logs" on "public"."finance_audit_log";

drop policy "Admins can view finance audit log" on "public"."finance_audit_log";
...
drop policy "Admins can insert job operations" on "public"."job_operations_log";

drop policy "Admins can read job operations logs" on "public"."job_operations_log";
...
drop policy "Admins can update refund fields on payments" on "public"."payments";

drop policy "Admins can view payments" on "public"."payments";

drop policy "Finance admin can cancel payments" on "public"."payments";

drop policy "Finance admin can mark payment failed" on "public"."payments";

drop policy "Finance admin can refund payments" on "public"."payments";
...
drop policy "support_ticket_messages_insert_admins" on "public"."support_ticket_messages";

drop policy "support_ticket_messages_insert_requesters" on "public"."support_ticket_messages";

drop policy "support_ticket_messages_select_admins" on "public"."support_ticket_messages";

drop policy "support_ticket_messages_select_requesters" on "public"."support_ticket_messages";

drop policy "support_ticket_messages_update_admins_read" on "public"."support_ticket_messages";
...
drop policy "Finance admin can manage withdrawals" on "public"."withdrawals";

alter table "public"."admin_action_log" drop constraint "admin_action_log_admin_id_fkey";
...
alter table "public"."finance_audit_log" drop constraint "finance_audit_log_admin_id_fkey";

alter table "public"."finance_audit_log" drop constraint "finance_audit_log_dispute_id_fkey";

alter table "public"."finance_audit_log" drop constraint "finance_audit_log_payment_id_fkey";
...
alter table "public"."job_operations_log" drop constraint "job_operations_log_job_id_fkey";
...
alter table "public"."payments" drop constraint "payments_refund_initiated_by_fkey";
...
drop policy "Admin contractor doc read" on "storage"."objects";
